...
import { promotionsData, type Promotion } from "@/data/promotions";
            ...
            <div style={{ padding: "24px 28px" }}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <ul style={{ paddingLeft: "20px", margin: 0 }}>
                  {selectedPromo.highlights.map((item, idx) => (
                    <li key={idx} style={{ fontSize: "0.9rem", color: "#444", marginBottom: "6px" }}>
                      {item}
                    </li>
                  ))}
                </ul>
                ...
                <div style={{ marginBottom: "24px", background: "#f8f9fa", padding: "14px 18px", borderRadius: "6px" }}>
                  ...
                  <ul style={{ paddingLeft: "18px", margin: 0 }}>
                    {selectedPromo.terms.map((term, idx) => (
                      <li key={idx} style={{ fontSize: "0.85rem", color: "#6c757d", marginBottom: "4px" }}>
                        {term}
                      </li>
                    ))}
                  </ul>
