...
const services = [
  ...
  { title: "Sửa chữa giá cố định", description: "Tham khảo gói sửa chữa với phạm vi công việc và mức giá công bố.", href: "/services/fixed-price-repair" },
