          ...
          <tr>
            <td style="padding:24px 40px;">
              <div style="background:#eef4fb;border-left:4px solid #1a3a5c;border-radius:6px;padding:16px 20px;">
                ...
                <p style="margin:0;font-size:20px;font-weight:700;color:#1a3a5c;letter-spacing:2px;">${registrationId}</p>
              </div>
            </td>
          </tr>
            ...
            <td style="padding:0 40px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e8f0;border-radius:8px;overflow:hidden;">
                ...
                <tr style="background:#fafbfc;border-top:1px solid #e0e8f0;">
                  ...
                  <td style="padding:12px 20px;font-size:13px;color:#1a3a5c;font-weight:600;">${retailer || "—"}</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding:0 40px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e8f0;border-radius:8px;overflow:hidden;">
                ...
                <tr style="border-top:1px solid #e0e8f0;">
                  ...
                  <td style="padding:12px 20px;font-size:13px;color:#1a3a5c;font-weight:600;">${email}</td>
                </tr>
                <tr style="background:#fafbfc;border-top:1px solid #e0e8f0;">
                  <td style="padding:12px 20px;font-size:13px;color:#7a8a9c;">Tỉnh/Thành phố</td>
                  <td style="padding:12px 20px;font-size:13px;color:#1a3a5c;font-weight:600;">${city || "—"}</td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td style="padding:0 40px 32px;">
              <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:8px;padding:16px 20px;">
                ...
                <p style="margin:0;font-size:13px;color:#78350f;line-height:1.6;">
                  Vui lòng lưu giữ email này và mã đăng ký <strong>${registrationId}</strong> để sử dụng khi cần liên hệ bảo hành. 
